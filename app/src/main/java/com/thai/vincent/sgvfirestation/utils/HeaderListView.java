...
import com.thai.vincent.sgvfirestation.R;
...
public class HeaderListView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Drawable scrollBarDrawable = context.getDrawable(R.drawable.scrollbar_handle_holo_light);
    ...
    private class HeaderListViewOnScrollListener implements AbsListView.OnScrollListener {
        ...
        private void updateScrollBar() {
            if (mHeader != null && mListView != null && mScrollView != null) {
                ...
                mScrollView.setPadding(0, top + 0, 0, bottom+0);
                fadeOut.reset();
        ...
        private void addSectionHeader(int actualSection) {
            ...
            if (mAdapter.hasSectionHeaderView(actualSection)) {
                ...
                //mHeaderConvertView = mAdapter.getCurrentConvertView(actualSection);
