...
public class MyNumberPicker extends NumberPicker {
    ...
    public MyNumberPicker(Context context, int minValue, int maxValue, int currentValue, int textColor){
        super(context);
    ...
    public MyNumberPicker(Context context, int minValue, int maxValue, int currentValue, int textColor, String[] displayedValues){
        super(context);
        setMinValue(minValue);
        setMaxValue(maxValue);
        setValue(currentValue);
